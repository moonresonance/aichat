...
"""
custom:
  bert_base_path: F:\\langchain_test_model\\LangGraph\\GPT_SoVITS\\pretrained_models\\chinese-roberta-wwm-ext-larg
  ...
  version: v2
v1:
  bert_base_path: F:\\langchain_test_model\\LangGraph\\GPT_SoVITS\\pretrained_models\\chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: GPT_SoVITS/pretrained_models/chinese-hubert-base
  device: cpu
  is_half: false
  t2s_weights_path: F:\\langchain_test_model\\LangGraph\\GPT_SoVITS\\pretrained_models\\chinese-roberta-wwm-ext-large
...
class TTS_Config:
    default_configs = {
        "v1": {
            ...
            "is_half": False,
            "version": "v1",
            # corrected example ckpt path (placeholder kept if actual file differs)
            "t2s_weights_path": "GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt",
            "vits_weights_path": "GPT_SoVITS/pretrained_models/s2G488k.pth",
            "cnhuhbert_base_path": "GPT_SoVITS/pretrained_models/chinese-hubert-base",
            # fix missing quote and ensure correct folder name
            "bert_base_path": "F:/langchain_test_model/LangGraph/gPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
        },
        "v2": {
            "device": "cpu",
        ...
        "v4": {
            ...
            "version": "v4",
            "t2s_weights_path": "GPT_SoVITS/pretrained_models/s1v3.ckpt",
            "vits_weights_path": "F:\langchain_test_model\LangGraph\gPT_SoVITS\pretrained_models\gsv-v4-pretrained\s2Gv4.pth",
            "cnhuhbert_base_path": "GPT_SoVITS/pretrained_models/chinese-hubert-base",
            "bert_base_path": "F:/langchain_test_model/LangGraph/gPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
        },
        "v2Pro": {
        ...
        "v2ProPlus": {
            ...
            "is_half": False,
            "version": "v2ProPlus",
            "t2s_weights_path": "F:\langchain_test_model\LangGraph\gPT_SoVITS\pretrained_models\GPT-SoVITS\s1v3.ckpt",
            "vits_weights_path": "F:\langchain_test_model\LangGraph\gPT_SoVITS\pretrained_models\\v2Pro\\s2Gv2ProPlus.pth",
            "cnhuhbert_base_path": "gPT_SoVITS/pretrained_models/chinese-hubert-base",
            "bert_base_path": "F:/langchain_test_model/LangGraph/gPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
        },
    }
...
class TTS:
    ...
    def init_bert_weights(self, base_path: str):
        ...
        # Normalize to absolute path to avoid HF treating it as repo_id
        abs_path = os.path.abspath(base_path)
        if os.path.isdir(abs_path):
            try:
                self.bert_tokenizer = AutoTokenizer.from_pretrained(abs_path, local_files_only=True)
                self.bert_model = AutoModelForMaskedLM.from_pretrained(abs_path, local_files_only=True)
            except Exception as e:
                print(f"Local BERT load failed from {abs_path}: {e}\nTrying remote repo 'hfl/chinese-roberta-wwm-ext-large'.")
                self.bert_tokenizer = AutoTokenizer.from_pretrained("hfl/chinese-roberta-wwm-ext-large")
                self.bert_model = AutoModelForMaskedLM.from_pretrained("hfl/chinese-roberta-wwm-ext-large")
        else:
            # If path invalid, fall back to known HF repo id.
            print(f"Path {abs_path} not found. Falling back to remote 'hfl/chinese-roberta-wwm-ext-large'.")
            self.bert_tokenizer = AutoTokenizer.from_pretrained("hfl/chinese-roberta-wwm-ext-large")
            self.bert_model = AutoModelForMaskedLM.from_pretrained("hfl/chinese-roberta-wwm-ext-large")
