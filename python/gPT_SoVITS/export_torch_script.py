...
cnhubert_base_path = "F:/langchain_test_model/LangGraph/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large"
...
def test():
    parser = argparse.ArgumentParser(description="GPT-SoVITS1 Command Line Tool")
