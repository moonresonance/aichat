...
cnhubert_base_path = os.environ.get("cnhubert_base_path", "F:/langchain_test_model/LangGraph/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large")
bert_path = os.environ.get("bert_path", "F:/langchain_test_model/LangGraph/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large")
...
with gr.Blocks(title="GPT-SoVITS1 WebUI", analytics_enabled=False, js=js, css=css) as app:
    gr.HTML(
        top_html.format(
